...
public class PizzasPedido extends EntityBase<PizzasPedido> implements Serializable {
	...
	private PizzasPedido ingrediente;

	@NotNull
	@Length(max=10)
	private int cantidad;

	public PizzasPedido(int ingredientesPizzaId, Pizzas pizza, PizzasPedido ingrediente,
	...
	public PizzasPedido getIngrediente() {
		return ingrediente;
	}

	public void setIngrediente(PizzasPedido ingrediente) {
		this.ingrediente = ingrediente;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PizzasPedido other = (PizzasPedido) obj;
