...
public class Usuarios extends EntityBase<Usuarios> implements Serializable {
	...
	private Usuarios ingrediente;

	@NotNull
	@Length(max=10)
	private int cantidad;

	public Usuarios(int ingredientesPizzaId, Pizzas pizza, Usuarios ingrediente,
	...
	public Usuarios getIngrediente() {
		return ingrediente;
	}

	public void setIngrediente(Usuarios ingrediente) {
		this.ingrediente = ingrediente;
	}
