...
public class IngredientesPizza extends EntityBase<IngredientesPizza> implements Serializable {
	...
	private IngredientesPizza ingrediente;

	@NotNull
	@Length(max=10)
	private int cantidad;

	public IngredientesPizza(int ingredientesPizzaId, Pizzas pizza, IngredientesPizza ingrediente,
	...
	public IngredientesPizza getIngrediente() {
		return ingrediente;
	}

	public void setIngrediente(IngredientesPizza ingrediente) {
		this.ingrediente = ingrediente;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IngredientesPizza other = (IngredientesPizza) obj;
