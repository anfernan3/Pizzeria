...
@RestController
@RequestMapping("/api/creapedidos")
public class PedidosControllers {
	...
	public List<Pedido> getAll() {
		//return srv.getAll().stream().map(item -> PedidosEditDTO.from(item)).toList();
		return srv.getAll();
	}
	...
	@GetMapping(path = "/{id}")
	@ApiOperation(value = "devuelve pedido por id")
	public Pedido ListadoporId(int id) throws NotFoundException {		
