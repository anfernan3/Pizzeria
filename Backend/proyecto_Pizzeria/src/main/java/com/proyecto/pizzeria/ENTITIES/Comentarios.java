...
public class Comentarios extends EntityBase<Comentarios> implements Serializable {
	...
	private Comentarios ingrediente;

	@NotNull
	@Length(max=10)
	private int cantidad;

	public Comentarios(int ingredientesPizzaId, Pizzas pizza, Comentarios ingrediente,
	...
	public Comentarios getIngrediente() {
		return ingrediente;
	}

	public void setIngrediente(Comentarios ingrediente) {
		this.ingrediente = ingrediente;
	}
